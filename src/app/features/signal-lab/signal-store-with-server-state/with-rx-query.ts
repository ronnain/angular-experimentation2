 ...
 * @returns
 */
export function withRxQuery<
  Input extends SignalStoreFeatureResult,
  const ResourceName extends string,
  ResourceState extends object | undefined,
  ResourceParams,
  ResourceArgsParams,
  QueryConfig extends RxResourceWithParamsOrParamsFn<any, any, any>,
  ...
  return ((context: SignalStoreFeatureResult) => {
    return signalStoreFeature(
      withProps((store) => {
        ...
        const queryResource = rxResource<ResourceState, ResourceParams>({
          ...queryConfigData.queryConfig,
          params: resourceParamsSrc,
        } as RxResourceOptions<any, any>);
...
const test = rxResource; // RxResourceOptions
